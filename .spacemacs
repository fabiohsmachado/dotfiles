;;; .spacemacs --- Dotfile for spacemacs
;;; Commentary:
;; -*- mode: emacs-lisp -*-
...
values."
  ...
  (setq-default
   ...
   ;; The leader key accessemanticsible in `emacs state' and `insert state'
   ;; (default "M-m")
   ...
   dotspacemacs-highlig-delimiters 'all
